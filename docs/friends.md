...
> 给工试 2523 同学的下一站索引：分流之后，可以从这里继续找到对应专业的课程资料、学习经验与通用技能教程。

!!! info "说明"
    本页整理自「资源、笔记与教程」清单。链接内容来自同学、学长学姐与开源社区的公开分享，请以原站说明为准。

    卡片按钮优先指向可直接阅读的笔记/资料页面；ZJU-OPT、ZJU-EE、ZJU_Course 暂未找到可用独立页面，因此保留到原始资料目录。

    能源方向目前暂未收录独立笔记站，后续补充后可放入第一组。

## 工试相关专业资源

<div class="grid cards friend-grid" markdown>

-   ![力速双 A - ZJUSAA avatar](assets/friends/zjusaa.svg){ .friend-avatar }

    **力速双 A - ZJUSAA** <span class="friend-source">航院</span>
...
-   ![Hikari of ME avatar](assets/friends/hikari-of-me.svg){ .friend-avatar }
    ...
    **Hikari of ME** <span class="friend-source">机械</span>
...
-   ![EEStUdy-Place avatar](assets/friends/eestudy-place.svg){ .friend-avatar }
    ...
    **EEStUdy-Place** <span class="friend-source">电气</span>
...
-   ![ZJU-EE avatar](assets/friends/zju-ee.svg){ .friend-avatar }
    ...
    **ZJU-EE** <span class="friend-source">电气</span>
...
-   ![一起学习德智体 avatar](assets/friends/dezhiti.svg){ .friend-avatar }
    ...
    **一起学习德智体** <span class="friend-source">电气</span>
...
-   ![zju-isee avatar](assets/friends/zju-isee.svg){ .friend-avatar }

    **zju-isee** <span class="friend-source">电信</span>
...
-   ![ZJU-OPT avatar](assets/friends/zju-opt.svg){ .friend-avatar }
    ...
    **ZJU-OPT** <span class="friend-source">光电</span>
...
-   ![控制学习驿站 avatar](assets/friends/ctrl-a.svg){ .friend-avatar }
    ...
    **控制学习驿站** <span class="friend-source">控制</span>
...
-   ![CourseNoteOfZJUSE avatar](assets/friends/zjuse-course-note.svg){ .friend-avatar }
    ...
    **CourseNoteOfZJUSE** <span class="friend-source">软工</span>
...
-   ![ZJU_Course avatar](assets/friends/zju-course.svg){ .friend-avatar }
    ...
    **ZJU_Course** <span class="friend-source">计科</span>
...
-   ![ZJU CS - All Sum in One! avatar](assets/friends/zju-cs-asio.svg){ .friend-avatar }
    ...
    **ZJU CS - All Sum in One!** <span class="friend-source">CS 索引</span>
...
-   ![图灵班学习指南 avatar](assets/friends/turing-courses.svg){ .friend-avatar }
    ...
    **图灵班学习指南** <span class="friend-source">CS 指南</span>
...
-   ![CTF101 avatar](assets/friends/ctf101.svg){ .friend-avatar }
    ...
    **CTF101** <span class="friend-source">信安</span>
...
-   ![HPC101 avatar](assets/friends/hpc101.svg){ .friend-avatar }
    ...
    **HPC101** <span class="friend-source">计算</span>
...
-   ![Computer-System-Start-From-a-Newbie avatar](assets/friends/computer-system-newbie.svg){ .friend-avatar }
    ...
    **Computer-System-Start-From-a-Newbie** <span class="friend-source">系统</span>
...
-   ![csdiy.wiki avatar](assets/friends/csdiy.svg){ .friend-avatar }
    ...
    **csdiy.wiki** <span class="friend-source">CS 自学</span>
...
-   ![浙江大学课程攻略共享计划 avatar](assets/friends/zju-icicles.svg){ .friend-avatar }

    **浙江大学课程攻略共享计划** <span class="friend-source">综合</span>
...
-   ![zju-welcome avatar](assets/friends/zju-welcome.svg){ .friend-avatar }
    ...
    **zju-welcome** <span class="friend-source">指南</span>
...
-   ![PracticalSkillsTutorial avatar](assets/friends/practical-skills.svg){ .friend-avatar }
    ...
    **PracticalSkillsTutorial** <span class="friend-source">技能</span>
...
-   ![数学之韵 avatar](assets/friends/zju-math.svg){ .friend-avatar }
    ...
    **数学之韵** <span class="friend-source">数学</span>
...
-   ![Linear-Algebra-Left-Undone avatar](assets/friends/linear-algebra-left-undone.svg){ .friend-avatar }
    ...
    **Linear-Algebra-Left-Undone** <span class="friend-source">线代</span>
...
-   ![路老师的 nonsense collection avatar](assets/friends/lu-nonsense.svg){ .friend-avatar }
    ...
    **路老师的 nonsense collection** <span class="friend-source">微积分</span>
...
-   ![Randall 爱数学 avatar](assets/friends/randall-math.svg){ .friend-avatar }
    ...
    **Randall 爱数学** <span class="friend-source">线代</span>
...
-   ![SLOFFDE avatar](assets/friends/sloffde.svg){ .friend-avatar }
    ...
    **SLOFFDE** <span class="friend-source">医学</span>
...
-   ![农生链 avatar](assets/friends/nongshenglian.svg){ .friend-avatar }
    ...
    **农生链** <span class="friend-source">农生环</span>
...
-   ![SurfingTutorial avatar](assets/friends/surfing-tutorial.svg){ .friend-avatar }

    **SurfingTutorial** <span class="friend-source">教程站</span>
...
-   ![How-To-Ask-Questions avatar](assets/friends/how-to-ask.svg){ .friend-avatar }
    ...
    **How-To-Ask-Questions** <span class="friend-source">教程站</span>
...
-   ![SurviveSJTUManual avatar](assets/friends/survive-sjtu.svg){ .friend-avatar }
    ...
    **SurviveSJTUManual** <span class="friend-source">手册站</span>
...
-   ![missing semester avatar](assets/friends/missing-semester.svg){ .friend-avatar }
    ...
    **missing semester** <span class="friend-source">教程站</span>
